#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To B-B H4CKER TEAM
...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|               B-B H4CKER
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;91m [⚡\033[1;97mAuthor Name: B-B H4ACKER⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl:  B-B H4ACKER ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Bangladesh       ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mH4CKER\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        os.system('xdg-open https://t.me/+4-EsosqnSMlmOTc1')
...
def pilih_super():
	...
	p.map(main, id)
#Dev:Babar_Ali
        print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mH4CKER\033[1;95m-_-_-_-_-_-_-_-_-»"
